...
public class Collections {
    ...
    /**
     * Добавляет все четные числа из массива в список.
     * Если список или массив == null - выбрасывает {@link IllegalArgumentException}
     * @param list Список. Может быть не пустым, тогда числа из массива добавляются в конец.
     * @param array Массив чисел
     */
    public static void addEven(List<Integer> list, int[] array) {
        // тут тебе нужно написать свою реализацию этого метода
    }
}
